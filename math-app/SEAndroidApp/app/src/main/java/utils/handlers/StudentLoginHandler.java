...
public class StudentLoginHandler extends HttpHandler {
    public StudentLoginHandler(String apiEndpoint, String success, String failure, Method method,
    ...
    protected void onPostExecute(String result) {
        if (result.equals(failure)) {
            ...
            StudentDataHandler handler = new StudentDataHandler(
                    context.getString(R.string.students_url) + context.getString(R.string.user_info),
